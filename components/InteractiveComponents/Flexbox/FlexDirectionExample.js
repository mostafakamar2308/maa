...
const FlexDirectionExample = () => {
  ...
  return (
    <div className="border p-4 border-lightText rounded-md gap-4">
      <div className="flex items-center">
        <button
          onClick={ChangeAxis}
          className="border border-lightText p-2 mb-2 rounded-lg"
        >
          تغيير الMain Axis
        </button>
      </div>
      <div
        className={`border border-red-300 p-4 bg-darkButtonUnimportantColor rounded-md flex gap-4 max-w-full relative ${
